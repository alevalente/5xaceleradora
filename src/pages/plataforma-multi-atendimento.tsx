...
const PlataformaMultiAtendimento = () => {
      ...
      <main className="flex-grow pt-24 pb-20">
        <div className="container-wide">
          ...
          <div className="glass-card p-8 mb-10">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gradient">Plataforma Multi-Atendimento</h1>
            <p className="text-xl text-white/80 mb-8">
              Nossa Plataforma Multi-Atendimento proprietária substitui o WhatsApp Web tradicional,
          ...
          <div className="glass-card p-8 mb-12">
            <h2 className="text-2xl font-bold mb-6 text-gradient text-center">Benefícios da Nossa Plataforma Multi-Atendimento</h2>
          ...
          <div className="glass-card p-8 text-center">
            ...
            <p className="text-white/80 mb-8 max-w-2xl mx-auto">
              Nossa Plataforma Multi-Atendimento pode ser implementada rapidamente e integrada
