...
const IntelligentSolutions = () => {
  ...
  const agentSolutions = [
    ...
    },
    {
      ...
      subtitle: 'Avalie automaticamente tudo o que sua equipe conversa com seus clientes.',
      description: 'Analise automaticamente, sem intervenção humana, conversas da equipe via WhatsApp, identificando melhorias e garantindo qualidade no atendimento.',
