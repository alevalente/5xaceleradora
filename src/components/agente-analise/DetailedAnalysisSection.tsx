  ...
  return (
    <div className="mb-16">
          ...
          {analysisItems.map((item, index) => (
            <div
              ...
              className={`
                ...
                bg-gray-800/30 border border-gray-600/20 backdrop-blur-sm
                transition-all duration-700 ease-out
                hover:bg-gray-800/50 hover:border-gray-500/30 hover:shadow-lg
                ${itemsAnimated[index] 
            ...
            >
              ...
              <div className="col-span-1 md:col-span-4 flex items-start space-x-4">
                ...
                <div>
                  <h5 className="text-xl font-bold text-white mb-2 leading-tight">
                    {item.title}
                  </h5>
      ...
      <div className="text-center mt-12">
        <div className="inline-flex items-center px-6 py-3 bg-green-500/10 border border-green-400/20 rounded-full backdrop-blur-sm">
